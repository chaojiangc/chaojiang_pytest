...
from tests_utills.get_yaml import get_yaml_stuf1
from songshu_code.songshuai_api import amg


@allure.feature("线下客户端登录业务")
@allure.story("学生账号正确，密码为空登录")
@allure.title("登录失败")
@pytest.mark.parametrize("datas", get_yaml_stuf1())
...
if __name__ == '__main__':
    pytest.main(["-s", "-v", "test_stulogin3.py"])