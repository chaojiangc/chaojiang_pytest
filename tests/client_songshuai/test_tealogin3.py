...
from tests_utills.get_yaml import get_yaml_tear2

from songshu_code.songshuai_api import amg


@allure.feature("线下客户端登录业务")
@allure.story("老师账号正确，密码为空登录")
@allure.title("登录失败")
@pytest.mark.parametrize("datas", get_yaml_tear2())
...
if __name__ == '__main__':
    pytest.main(["-s", "-v", "test_tealogin3.py"])